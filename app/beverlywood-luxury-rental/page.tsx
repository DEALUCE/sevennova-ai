      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '80px 40px' }}>
        ...
        <div style={{ marginTop: '64px', paddingTop: '40px', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
            {[['Furnished Rental Los Angeles', '/furnished-rental-los-angeles'], ['Kosher Rental LA', '/kosher-rental-los-angeles'], ['FIFA 2026 Rental', '/fifa-2026-rental-los-angeles'], ['Luxury Rental 90035', '/luxury-rental-90035'], ['Full Listing', '/luxury-rental']].map(([label, href]) => (
